 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,s,i,e){const n=s[0];if("."===n){return new k(t,s.slice(1),i).parts}if("@"===n)return[new O(t,s.slice(1),e.eventContext)];if("?"===n)return[new $(t,s.slice(1),i)];return new _(t,s,i).parts}handleTextExpression(t){return new A(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
var tt=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,h=t.length-1;h>=0;h--)(n=t[h])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let st=class extends Z{constructor(){super(...arguments),this.name="World",this.data=[],this.count=0}render(){return V`
  ...
  `,tt([G()],st.prototype,"name",void 0),tt([G({type:Array})],st.prototype,"data",void 0),tt([G({type:Number})],st.prototype,"count",void 0),st=tt([(it="my-button",t=>"function"==typeof t?((t,s)=>(window.customElements.define(t,s),s))(it,t):((t,s)=>{const{kind:i,elements:e}=s;return{kind:i,elements:e,finisher(s){window.customElements.define(t,s)}}})(it,t))],st);export{st as MyButton};
